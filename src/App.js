            ...
            >
              <div>
                <Switch>
                  ...
                  <Route path="/TagCloud" component={TagCloudDemo} />
                  ...
                  />
                  <Route path="/CardStack" component={CardStackDemo} />
                  <Route path="/Animator" component={Animator} />
                  <Route path="/Grid" component={GridDemo} />
                  <Route path="/AutoSuggest" component={AutoSuggestDemo} />
                  <Route path="/Search" component={SearchDemo} />
                  <Route path="/OmniBar" component={OmniBarDemo} />
                </Switch>
              </div>
            </ContentWithPanel>
          </CenteredContent>
